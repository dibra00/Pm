...
class _SettingState extends State<Setting> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Text('setting:',style: TextStyle(fontSize: 40,fontWeight: FontWeight.w100, color: Colors.yellow,fontFamily: 'MTCORSVA', decoration: TextDecoration.none),),
      content: Container(
          color: Colors.black,
          height: height/7,
          child: Column(
            ...
            children: <Widget>[
              Row( mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                Text('Play Sounds:',style: TextStyle(fontSize: 28,fontWeight: FontWeight.w100, color: Colors.yellow,fontFamily: 'MTCORSVA', decoration: TextDecoration.none),),
                CustomSwitch(
...
class _HandsState extends State<Hands> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
          ...
          child: DropdownButton<int>(
            ...
            items: <int>[ 2, 3, 4, 5, 6, 7, 8, 9, 10]
              ...
              return DropdownMenuItem<int>(
                value: value,
                child: Text(value.toString(), style: TextStyle(fontSize: 27,fontWeight: FontWeight.w500, color: Colors.yellow,fontFamily: 'MTCORSVA'),),
              );
            }).toList(),
          ),
        ),
      ...
      actions: <Widget>[
        FlatButton(onPressed: () {
          //TODO bayad begim ba tedad playerNo bere be safhe bazi va shoro bazi
          //print('********' + playerNo.toString());
          thirdScreen();
        },
            child: Text('ok', style: TextStyle(fontSize: 30,fontWeight: FontWeight.w100, color: Colors.yellow,fontFamily: 'MTCORSVA'),
            ))
